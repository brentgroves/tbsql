...
select count(*) 
from Plex.account_period_balance apb -- 161,900,157,283/32,253
where pcn = 123681
-- and period = 202107 -- 4617
and period between 202207 and 202208 -- 9,234/0

select * from Plex.accounting_period_ranges r

select distinct pcn,period from Plex.account_activity_summary  order by pcn,period

select * 
-- select count(*)
from Plex.account_activity_summary aas 
where pcn = 123681  -- 9234
-- and period = 202207 -- 4617
and period = 202208 -- 4617
...
-- exec Plex.debug_recreate 123681
