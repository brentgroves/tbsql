...
show indexes from Plex.trial_balance_multi_level 
-- CREATE INDEX idx_account_activity_summary ON Plex.accounting_account(pcn,account_no);

-- delete from Plex.trial_balance_multi_level where script_key = 8;

-- truncate TABLE Plex.trial_balance_multi_level;
select * from Plex.trial_balance_multi_level limit 10
insert into Plex.trial_balance_multi_level(period)
values
(123681,202212,'12-2022','category_type','category_name','sub_category_name','account_no',0.00,0.00)
