...
-- drop table Plex.trial_balance_multi_level_py
create table Plex.trial_balance_multi_level_py
(
 pcn int null,
 period int null,
 ...
 CONSTRAINT PK_trial_balance_multi_level_py primary key (period_display,account_no)  -- when this gets imported there is a period_display but no period.
)
select distinct pcn,period 
from Plex.trial_balance_multi_level_py order by pcn,period  
select count(*) from Plex.trial_balance_multi_level_py  -- 4,204
where period = 202203
...
-- delete from Plex.trial_balance_multi_level_py where period between 202305 and 202305


insert into Plex.trial_balance_multi_level_py(pcn,period_display)
values
(123681,'12-2022')
...
select * 
-- select count(*)
--select count(*) from Archive.trial_balance_multi_level_py_01_02_2022  -- 668,436 (200812-202112) -- I deleted 202112 because this period did not close as of 01-07-2022.
-- into Archive.trial_balance_multi_level_py_2022_07_23--693,660

--into Archive.trial_balance_multi_level_py_06_11_2022--689456

--into Archive.trial_balance_multi_level_py_05_13_2022--685252
--into Archive.trial_balance_multi_level_py_01_02_2022
from Plex.trial_balance_multi_level_py  -- 58,856
...
-- select count(*)
from Plex.trial_balance_multi_level_py s1  -- 58,856
join Plex.trial_balance_multi_level_py s2
...
delete from Plex.trial_balance_multi_level where period between 202210 and 202301 and PCN in (123681)
select *
--SELECT DISTINCT pcn,period
--SELECT DISTINCT pcn,period_display 
--select count(*)
from Plex.trial_balance_multi_level_py
...
s.trial_balance_debit_credit -- trial_balance_multi_level_py
...
(
	...
	d.current_debit_credit trial_balance_debit_credit,-- trial_balance_multi_level_py
	p.Current_Debit,p.Current_Credit,
	...
	*/
	...
	--select distinct pcn,period
	--select count(*)
	from Plex.trial_balance_multi_level_py d -- 54,652
...
select *
--select count(*)
from Plex.trial_balance_multi_level_py d 
where d.pcn = 123681 
...
select count(*)
from Plex.Account_Balances_by_Periods p 
left outer join Plex.trial_balance_multi_level_py d 
on d.pcn = p.pcn 
and d.account_no = p.[no]
and d.period=p.period  
