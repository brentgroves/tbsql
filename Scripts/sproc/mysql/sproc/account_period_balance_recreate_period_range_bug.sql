Bug fix: 11/30/2023
--Added account_no TO the FOLLOWING code
...
--	)
Backup: Plex.accounting_account_year_category_type,account_period_balance
-- select * 
--	into Archive.accounting_account_year_category_type_11_30_2023 
--	from Plex.accounting_account_year_category_type 
-- select count(*) from Archive.accounting_account_year_category_type_11_30_2023 -- 41,381
-- select top 10 * from Archive.accounting_account_year_category_type_11_30_2023 -- 41,381
...
proc_Exit:begin
	...
	select y.pcn,y.account_no,v_prev_period div 100y.`year`,y.category_type,y.revenue_or_expense
	from Plex.accounting_account_year_category_type y
